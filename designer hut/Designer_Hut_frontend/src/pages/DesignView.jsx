...
import { Eye, FileInput, Pencil, Trash2, Upload } from 'lucide-react';
  ...
  useEffect(() => {
    const getUploaded = async () => {
      try {
        ...
        console.log("Fetched uploaded designs:", res.data.upload_Data);
        setData(res.data.upload_Data ?? []);
      } catch (error) {
      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          ...
          <div className="w-full md:w-auto">
            <Label htmlFor="category" className="block mb-1 text-sm text-gray-700">Filter by Category</Label>
            <select
              id="category"
              name="category"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
              {data.map((design) => (
                ...
                >
                  ...
                  <div className='ml-5 mb-3 hover:bg-gray-600'>
                      <button
