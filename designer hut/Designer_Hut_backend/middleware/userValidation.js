...
exports.designerjobValidation = [
  ...
  body("contact_information.email")
    .notEmpty()
    .withMessage("contact information is required"),
  body("contact_information.phone")
    .notEmpty()
    .withMessage("contact information is required"),
...
exports.designerjobapplicationValidation = [
  body("job").notEmpty().withMessage("job is required filed"),
   body("company_name").notEmpty().withMessage("company_name  is required filed"),
    body("jobtype").notEmpty().withMessage("jobtype is required filed"),
     body("logo").notEmpty().withMessage("logo is required filed"),
]
